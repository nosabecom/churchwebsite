...
$HookKey = "WOMAN_EXCEL_VERCEL_DEPLOY_HOOK_URL"
...
$HookUrl = $env:WOMAN_EXCEL_VERCEL_DEPLOY_HOOK_URL
if (-not $HookUrl) {
    $SecureHook = Read-Host "Woman Excel Vercel deploy hook URL" -AsSecureString
