...
- The live 2025 and 2026 Woman Excel conference pages use real, supplied event imagery. Ten stock files remain referenced by the public conference template, fellowship homepage, or newsletters; they are marked \`replace\` and must not be uploaded to Sanity.
...
1. Replace all ten \`apps/womanexcel/public/images/placeholds/photo-*.jpg\` files or retire their remaining usages. They are no longer used by the live 2025/2026 conference pages, but the public \`/conference/template\` route, fellowship homepage, and three newsletters still reference them.
...
3. Confirm permission and credit for every editorial asset before upload, including the 48 new Woman Excel 2025/2026 gallery photographs, eight speaker/performer cutouts, both pastor portraits, and the conference posters/programmes.
